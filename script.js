...
.message-bubble:not(.redpacket-bubble):not(.transfer-bubble){border-radius:var(--wx-bubble-radius) !important;padding:var(--wx-bubble-py) var(--wx-bubble-px) !important;}
.message-bubble.redpacket-bubble,.message-bubble.transfer-bubble{padding:0 !important;border-radius:8px !important;}
.message-row.right .message-bubble:not(.redpacket-bubble):not(.transfer-bubble){background-color:var(--wx-user-bubble) !important;}
.message-row.right .message-bubble:not(.redpacket-bubble):not(.transfer-bubble)::before{border-left-color:var(--wx-user-bubble) !important;}
.message-row.left .message-bubble:not(.redpacket-bubble):not(.transfer-bubble){background-color:var(--wx-ai-bubble) !important;}
.message-row.left .message-bubble:not(.redpacket-bubble):not(.transfer-bubble)::before{border-right-color:var(--wx-ai-bubble) !important;}
`.trim();
}
